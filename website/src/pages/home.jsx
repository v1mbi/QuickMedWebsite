              ...
              >
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="col-span-2 bg-gradient-to-br from-red-500 to-rose-600 text-white rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-xl shadow-rose-500/10 min-h-[280px] sm:min-h-[300px] border border-rose-400/20 relative overflow-hidden group"
                  >
