  ...
  return (
    <main className="font-montserrat bg-slate-50 w-full text-slate-800  antialiased scroll-smooth min-h-screen">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex items-center justify-center">
        ...
        {/* WhatsApp Button */}
        <a
          href="https://wa.me/447859292790?text=Good%20Day!%20I%20have%20an%20inquiry."
          target="_blank"
          rel="noopener noreferrer"
          className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition-all duration-300 hover:scale-110 hover:bg-[#20ba5a] hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-green-300"
