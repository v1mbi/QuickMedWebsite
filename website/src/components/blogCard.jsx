      ...
      >
        <div className="flex h-full flex-row p-4 gap-6">
          ...
          <div className="flex flex-col justify-between py-2">
            <div>
              <span className="text-[10px] font-bold tracking-widest text-rose-500 uppercase">Article</span>
              <h2 className="text-2xl font-bold font-jakarta text-slate-900 mt-1 mb-3 group-hover:text-rose-600 transition-colors">
                {title}
              </h2>
              <p className="text-slate-600 text-sm line-clamp-4 font-jakarta leading-relaxed">
                {message}
              </p>
            </div>
                ...
                <div className="max-w-2xl mx-auto">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 text-sm mt-1">{date} • 5 min read</p>
                    </div>
                  </div>

                  <h1 className="text-4xl sm:text-5xl font-jakarta font-black text-slate-900 leading-tight mb-8">
                    {title}
                  </h1>

                  <div className="prose prose-slate max-w-none">
                    <p className="text-lg font-jakarta text-slate-600 leading-loose first-letter:text-5xl first-letter:font-bold first-letter:text-rose-600 first-letter:mr-3 first-letter:float-left">
                      {message}
                    </p>
                  </div>
