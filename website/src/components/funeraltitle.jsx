...
import image from "../assets/funeralWallPaper.jpeg";
  ...
  return (
    <div className="relative w-full h-[75vh] flex items-center justify-center font-sans overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl px-6 flex flex-col items-center">
        ...
        >
          <h1 className="text-4xl sm:text-5xl  font-jakarta md:text-7xl lg:text-8xl font-bold text-slate-900 tracking-tighter text-center  leading-none">
