      ...
      <div className="relative z-10 w-full max-w-5xl px-6 flex flex-col items-center">
        ...
        >
          <h1 className="text-5xl font-jakarta md:text-7xl lg:text-8xl font-bold text-slate-900 tracking-tighter text-center  leading-none">
            Funeral <span className="text-red-600">Insurance</span>
          </h1>
        </motion.div>
        ...
        <div className="flex flex-col md:flex-row justify-between w-full mt-2 gap-2 md:gap-4">
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-fit py-1 sm:py-4 font-montserrat md:py-3 px-3 sm:px-10 bg-gradient-to-b  from-blue-500 to-blue-600 text-white rounded-2xl font-bold text-[14px] sm:text-sm shadow-lg shadow-blue-100 uppercase tracking-widest transition-all"
          >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-fit font-montserrat py-4 md:py-3 px-10 bg-gradient-to-b  from-red-500 to-red-600 text-white rounded-2xl font-bold text-sm shadow-lg shadow-red-100 uppercase tracking-widest transition-all"
          >
