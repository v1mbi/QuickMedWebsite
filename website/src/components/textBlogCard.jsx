      ...
      >
        ...
        <div className="relative z-10 flex flex-col flex-1">
          <div className="flex items-center gap-3 mb-2">
            <span className="text-[8px] sm:text-[10px] font-black tracking-[0.2em] text-rose-500 uppercase">
              Editorial
            </span>
          ...
          <h2 className="text-[20px] sm:text-2xl font-jakarta font-bold text-slate-900 leading-[1.15] mb-4 group-hover:text-rose-600 transition-colors duration-300">
            {title}
          </h2>

          <p className="text-slate-500 text-[0.525rem] sm:text-sm leading-relaxed line-clamp-10 sm:line-clamp-4 font-jakarta">
            {message}
          </p>

          <div className="mt-6 pt-2  border-t border-slate-50 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="h-5 w-5 sm:h-8 sm:w-8 rounded-full bg-slate-100 flex items-center justify-center text-rose-600 font-bold text-xs border border-rose-100">
                {author.charAt(0)}
              </div>
              <span className="text-[0.625rem] sm:text-sm font-bold text-slate-800">
                {author}
              </span>
            </div>
          ...
          <div className="relative w-full top-6 max-w-3xl max-h-[80vh] bg-white rounded-[2.5rem] shadow-2xl overflow-y-auto animate-in zoom-in-95 duration-300">
            ...
            <div className="p-10 sm:p-16 md:p-24">
              <header className="text-center mb-12">
                ...
                <h1 className="text-xl sm:text-5xl md:text-6xl font-jakarta font-black text-slate-900 leading-[1.1] mb-10">
                  {title}
                </h1>

                <div className="flex items-center justify-center gap-4 text-slate-400 text-[0.325rem] sm:text-sm font-medium uppercase tracking-tighter">
              ...
              <div className="max-w-xl mx-auto">
                <div className="prose prose-slate prose-lg">
                  ...
                  <p className="text-xs sm:text-lg font-jakarta text-slate-600 leading-[2] first-letter:text-6xl first-letter:font-black first-letter:text-rose-600 first-letter:mr-3 first-letter:float-left">
                    {message}
                  </p>
                </div>
                ...
                <div className="mt-16 pt-10 border-t border-slate-100 flex justify-center">
                  ...
                  >
                    <span className="group-hover/close:-translate-x-2 transition-transform">
                      ←
                    </span>
                    BACK TO FEED
                  </button>
